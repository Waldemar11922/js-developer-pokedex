    ...
    const htmlString = `
      ...
      <div id="modal">
          <div id="modal-content">
              <button id="closeBtn" onClick="closeModal()">voltar</button>
                  ...
                  <div id="data">
                      ...
                      <div id="hability">
                          <div class="stat-desc">
                              ...
                              `<p class="${type}">${name_stats.stat.name}</p>`).join("")}</p>
                          </div>
                          <div class="bar-inner"> ${pokemon.stats.map((base_stats) =>
                              `<p class="${type}">${base_stats.base_stat}</p>`).join("")}</p>
                          </div>
                      </div>
                      <div id="stats">
                          <div class="stat-bar">
